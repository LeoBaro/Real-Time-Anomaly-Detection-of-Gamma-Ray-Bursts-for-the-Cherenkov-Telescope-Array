...
nohup python $cta_sag_sci_path/RTAscience/simGRBcatalogWithRandomization.py -f config.yml --output-dir $output_dir_sim --print no --mp-threads 10 2>&1 > $this_dir/simulation.log &
