...
if __name__=='__main__':
    ...
    parser.add_argument('-id', '--input-dir', type=str, help='Output dir')
    ...
    print("background_counts:",background_counts)
    print("events_counts:",events_counts)
    print("Total:",background_counts+events_counts)
